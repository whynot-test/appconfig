...
/**
 * @Author: bijunjian
 * @createTime: 2023年08月30日 23:38:29
 * @version: V1
 * @Description: 删除配置
 */
public class ConfigInfoDelete {
    ...
    /**
     * 移动子系统中取消引用批量新增配置信息删除表用
     * @param configInfo 取消引用的配置信息
     * @param cQuoteApp 引用的子系统ID
     */
    public ConfigInfoDelete(ConfigInfo configInfo, String cQuoteApp) {
        this.cBh = configInfo.getcBh();
        this.cBhSystem = configInfo.getcBhSystem();
        this.cXtbh = configInfo.getcXtbh();
        this.cFzbh = configInfo.getcFzbh();
        this.cFzmc = configInfo.getcFzmc();
        this.cMc = configInfo.getcMc();
        this.cKey = configInfo.getcKey();
        this.cMrz = configInfo.getcMrz();
        this.cSm = configInfo.getcSm();
        this.nWh = configInfo.getnWh();
        this.nYx = configInfo.getnYx();
        this.nXslx = configInfo.getnXslx();
        this.dXgsj = configInfo.getdXgsj();
        this.cPzdm = configInfo.getcPzdm();
        this.nXssx = configInfo.getnXssx();
        this.cScope = configInfo.getcScope();
        this.cSjxt = configInfo.getcSjxt();
        this.cXq = configInfo.getcXq();
        this.cGnyx = configInfo.getcGnyx();
        this.cDq = configInfo.getcDq();
        this.cParent = configInfo.getcParent();
        this.values = configInfo.getValues();
